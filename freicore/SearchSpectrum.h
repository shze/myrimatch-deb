//
// $Id: SearchSpectrum.h 198 2012-09-25 22:02:27Z chambm $
//
...
//		typedef SearchSpectraList< SpectrumType, ListType >			ListType;
                                          ...
                                          const string& ionSeriesList) const
        {
            ...
            BOOST_FOREACH(const string& ionSeries, tokens)
            {
                ...
                else if (ionSeries == "a-NH3")      sip.additionalSearchParams.set(MS_param__a_ion_NH3);
                else if (ionSeries == "a-H2O")      sip.additionalSearchParams.set(MS_param__a_ion_H2O);
                else if (ionSeries == "b")          sip.additionalSearchParams.set(MS_param__b_ion);
                else if (ionSeries == "b-NH3")      sip.additionalSearchParams.set(MS_param__b_ion_NH3);
                else if (ionSeries == "b-H2O")      sip.additionalSearchParams.set(MS_param__b_ion_H2O);
                ...
                else if (ionSeries == "y-NH3")      sip.additionalSearchParams.set(MS_param__y_ion_NH3);
                else if (ionSeries == "y-H2O")      sip.additionalSearchParams.set(MS_param__y_ion_H2O);
